...
-- 다른 테이블들도 여기에 이어서 CREATE TABLE 문으로 작성합니다.
-- CONCERT_DATE, SEAT, RESERVATION, PAYMENT 등
-- 외래 키(FOREIGN KEY) 제약 조건도 여기에 포함됩니다.
...
CREATE TABLE `SEAT` (
    ...
    `seat_grade` ENUM('VIP', 'PREMIUM', 'NORMAL') NOT NULL COMMENT '좌석 등급',
