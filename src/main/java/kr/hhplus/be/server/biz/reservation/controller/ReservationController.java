package kr.hhplus.be.server.biz.reservation.controller;

import kr.hhplus.be.server.biz.reservation.dto.ReservationRequest;
import kr.hhplus.be.server.biz.reservation.dto.ReservationResponse;
...
public class ReservationController {
     ...
     */
    @PostMapping
    public ResponseEntity<ReservationResponse> reserveSeatTemporarily(@Valid @RequestBody ReservationRequest request) {
        try {
